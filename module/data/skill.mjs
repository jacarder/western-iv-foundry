...
export default class WesternIVSkill extends WesternIVItemBase {
	...
	getTotalPoints(actor, [attr1, attr2]) {
		console.log(actor, actor.system.abilities[attr1.toLowerCase()], actor.system.abilities[attr2.toLowerCase()])
		return this.practicePoints + actor.system.abilities[attr1.toLowerCase()].mod + actor.system.abilities[attr2.toLowerCase()].mod;
	}

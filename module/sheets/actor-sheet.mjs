 ...
 * @extends {ActorSheet}
 */
export class WesternIVActorSheet extends ActorSheet {
  /** @override */
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ['western-iv', 'sheet', 'actor'],
      width: 600,
      height: 600,
      tabs: [
        {
  ...
  /** @override */
  get template() {
    return `systems/western-iv/templates/actor/actor-${this.actor.type}-sheet.hbs`;
  }
  ...
  _prepareCharacterData(context) {
    ...
    //   v.label = game.i18n.localize(CONFIG.WESTERN_IV.abilities[k]) ?? k;
    // }
  }
